...
define('G5_MYSQL_USER', 'brickup');
define('G5_MYSQL_PASSWORD', 'qmflrdjq0605');
define('G5_MYSQL_DB', 'brickup');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'br_');

define('G5_TOKEN_ENCRYPTION_KEY', '42517b47b52b76679b50050fb780bc58'); // 토큰 암호화에 사용할 키
