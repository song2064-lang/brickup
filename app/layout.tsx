...
<<<<<<< HEAD
  ...
  keywords: ["브릭업", "프랜차이즈", "창업", "브랜드 컨설팅", "인큐베이팅", "매칭", "프랜차이즈 본사"],
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://brickup.co.kr/kakao-og-image.jpg",
        width: 1200,
        height: 628,
...
<<<<<<< HEAD
        ...
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-Q9SKNHERQX" strategy="afterInteractive" />
