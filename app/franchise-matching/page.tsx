        ...
        <div className="grid grid-cols-1 lg:[grid-template-columns:1fr_700px] gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <button
              type="submit"
              disabled={!agreed}
              className="w-full h-[52px] rounded-lg bg-[#16469E] text-white text-[16px] font-semibold
                         disabled:opacity-50 disabled:cursor-not-allowed hover:brightness-[1.03] active:brightness-[0.97]
                         shadow-[0_6px_16px_rgba(22,70,158,0.25)] transition"
            >
              문의하기
            </button>
          </form>
      ...
      {showPrivacyModal && (
        ...
        >
          ...
          >
            ...
            <div className="px-6 py-4 overflow-auto text-[14px] leading-[1.7] text-[#4B5563]">
              <p className="mb-4">
                주식회사 브릭업(이하 "회사"라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와
...
export default function FranchiseMatching() {
  ...
  return (
    <div className="relative w-full bg-white pb-16 lg:pb-16">
      ...
      <div className="fixed bottom-0 left-0 w-full z-50 bg-[#16469E] text-[#111827] shadow-[0_-2px_8px_rgba(0,0,0,0.1)]">
        <form
          onSubmit={(e) => {
            e.preventDefault()
          ...
          className="max-w-[1440px] mx-auto flex flex-wrap lg:flex-nowrap items-center justify-between gap-3 px-4 py-3 lg:px-8"
        >
          {/* 좌측 로고 */}
          <img src="/images/brickup-logo-ww.png" alt="Brickup Logo" className="w-[120px] h-auto" />

          {/* 문의유형 - white background with black text */}
          <select
            className="flex-1 min-w-[150px] h-[45px] rounded-md px-3 text-[14px] bg-white text-[#111827] border border-[#D1D9E8] focus:outline-none focus:border-[#16469E] focus:ring-2 focus:ring-[#16469E]/20"
            required
          >
            ...
            <option value="R&D">R&D(메뉴개발)</option>
            <option value="마케팅">마케팅</option>
          </select>

          {/* 브랜드명 - white background with black text */}
          <input
            type="text"
            placeholder="브랜드명"
            className="flex-1 min-w-[150px] h-[45px] rounded-md px-3 text-[14px] bg-white text-[#111827] placeholder:text-[#9CA3AF] border border-[#D1D9E8] focus:outline-none focus:border-[#16469E] focus:ring-2 focus:ring-[#16469E]/20"
          />

          {/* 성함 - white background with black text */}
          <input
            type="text"
            placeholder="성함"
            className="flex-1 min-w-[120px] h-[45px] rounded-md px-3 text-[14px] bg-white text-[#111827] placeholder:text-[#9CA3AF] border border-[#D1D9E8] focus:outline-none focus:border-[#16469E] focus:ring-2 focus:ring-[#16469E]/20"
          />

          {/* 연락처 - white background with black text */}
          <input
            type="tel"
            placeholder="연락처"
            className="flex-1 min-w-[160px] h-[45px] rounded-md px-3 text-[14px] bg-white text-[#111827] placeholder:text-[#9CA3AF] border border-[#D1D9E8] focus:outline-none focus:border-[#16469E] focus:ring-2 focus:ring-[#16469E]/20"
          />

          {/* 개인정보 동의 - with underlined clickable text */}
          <label className="flex items-center gap-2 text-white text-[14px] whitespace-nowrap cursor-pointer">
            <input type="checkbox" name="consent" className="w-[16px] h-[16px] accent-[#FFEB00]" />
            <span
              className="underline hover:text-[#FFEB00] transition-colors cursor-pointer"
              onClick={(e) => {
                e.preventDefault()
          ...
          <button
            type="submit"
            className="flex items-center justify-center gap-2 bg-[#FFEB00] hover:brightness-110 text-[#111827] font-bold rounded-md px-6 py-3 transition-all min-w-[120px]"
          >
            <svg
      ...
      {showPrivacyModal && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <h3 className="text-[18px] font-bold text-[#111827]">개인정보 수집 및 이용 동의</h3>
              <button
                onClick={() => setShowPrivacyModal(false)}
                className="text-[#6B7280] hover:text-[#111827] text-[24px] leading-none transition-colors"
              >
            ...
            <div className="px-6 py-4 overflow-auto text-[14px] leading-[1.7] text-[#4B5563]">
              ...
              <h4 className="font-bold text-[#111827] mb-2">제1조(개인정보의 처리목적)</h4>
              <p className="mb-4">
                회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 이용 목적이 변경되는
              ...
              <h4 className="font-bold text-[#111827] mb-2">제3조(정보주체의 권리·의무 및 행사방법)</h4>
              <p className="mb-4">
                정보주체는 회사에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
                권리 행사는 회사에 대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
                통하여 하실 수 있으며 회사는 이에 대해 지체 없이 조치하겠습니다.
              </p>

              <h4 className="font-bold text-[#111827] mb-2">제4조(개인정보의 파기)</h4>
              <p className="mb-4">
                회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당
                개인정보를 파기합니다. 정보주체로부터 동의받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도
                불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의
                데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.
              </p>

              <h4 className="font-bold text-[#111827] mb-2">제5조(개인정보의 안전성 확보조치)</h4>
