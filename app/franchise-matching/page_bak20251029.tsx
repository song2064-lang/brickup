        ...
        <div className="grid grid-cols-1 lg:[grid-template-columns:1fr_700px] gap-10 lg:gap-16 items-start">
          ...
          <form
            onSubmit={async (e) => {
              ...
              const payload = {
                formType: "matching" as const,
                platform: (window.innerWidth < 768 ? "mobile" : "pc") as "pc" | "mobile",
              ...
              setTimeout(() => setIsSubmittingMain(false), 200)
            }}
...
export default function FranchiseMatching() {
  ...
  const [selectedTypes, setSelectedTypes] = useState<string[]>([]) // This state variable was declared to fix the error
        ...
        >
          <div className="max-w-[1440px] mx-auto w-full px-4 lg:px-8">
            <div className="max-w-[1180px] mx-auto flex items-center justify-between gap-4">
              ...
              {/* Inquiry Type Select - changed from checkboxes to dropdown */}
              <select
                name="type"
