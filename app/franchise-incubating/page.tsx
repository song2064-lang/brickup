...
import { MobileStickyInquiry } from "@/components/mobile-sticky-inquiry" // Import MobileStickyInquiry component at the top
...
export default function FranchiseIncubatingPage() {
  ...
  const [isSubmittingBottom, setIsSubmittingBottom] = useState(false) // New state for footer form submission
  ...
  const serviceCards = [
    {
      ...
      content: (
        <>
          <p className="font-semibold mb-4 text-white" style={{ fontSize: "16px" }}>
            로고·BI/CI·브랜드 스토리 설계
          </p>
          <p className="mb-0.5">브릭업의 브랜딩은 단순한 디자인이 아니라, 시장에서 통하는 '브랜드 언어'를</p>
          <p className="mb-0.5">만드는 과정입니다.</p>
          <p className="mb-0.5">로고, 컬러, 슬로건, 매장 톤앤매너 등 시각적 요소뿐 아니라, 브랜드가 소비자에게</p>
          <p className="mb-2">
            어떤 감정과 경험을 남길지까지 설계합니다.
            <br />
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          <p className="font-semibold mb-4 text-white" style={{ fontSize: "16px" }}>
            검증된 세일즈 시스템으로, 안정적이면서 속도감 있는 확장
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          <div className="mb-4">
            <p className="font-semibold text-white" style={{ fontSize: "16px" }}>
              브랜드를 알리고, 점포 매출을 키우는 마케팅
            </p>
            <p className="font-semibold text-white" style={{ fontSize: "16px" }}>
              단순 홍보가 아닌, 실제 매출로 연결되는 전략
            </p>
          </div>
          <p className="mb-2">
          ...
          <p className="font-semibold text-white mt-4" style={{ fontSize: "16px" }}>
            우리는 노출이 아니라, 매출로 증명합니다.
          </p>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          ...
          <p className="font-semibold text-white" style={{ fontSize: "16px" }}>
            브랜드의 얼굴을 만드는 디자인, 본사와 점주 모두가 만족하는 시공
          </p>
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <>
          <p className="font-semibold mb-4 text-white" style={{ fontSize: "16px" }}>
            가맹 계약 · 상표권 · 분쟁 예방까지, 프랜차이즈의 안전망
          </p>
          <p className="mb-4">
            브릭업은 외부 법률전문 자문단과 협력하여
            <br /> 프랜차이즈 본사가 법적 리스크 없이 성장할 수 있는 구조를 설계합니다.
            <br />단 한 번의 실수가 브랜드 전체를 흔들 수 있기에,
            <br /> 브릭업은 기획 단계부터 법률을 함께 검토합니다.
          </p>
          <div className="space-y-2 mb-4">
          ...
          <p className="font-semibold text-white" style={{ fontSize: "16px" }}>
            법은 브랜드의 마지막 방어선입니다. 브릭업은 처음부터 대비합니다.
          </p>
        </>
      ),
    },
  ...
  return (
    <div className="relative w-full min-h-screen bg-black overflow-x-hidden pb-[var(--mobile-sticky-height,0px)] lg:pb-0">
      ...
      <section className="hidden lg:flex relative w-full h-screen flex-col overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
          <div className="animate-bounce">
            <Image src="/images/design-mode/image.png" alt="Scroll" width={32} height={48} className="opacity-70" />
          </div>
        </div>
      </section>
              ...
              {serviceCards.map((card, index) => (
                ...
                >
                  <div className="flex items-baseline gap-2 mb-4 lg:mb-5">
                    <h3
                      className="text-white text-lg lg:text-xl font-bold group-hover:text-[#4A8FFF] transition-colors duration-300"
                      style={{ fontSize: "24px" }}
                    >
            ...
            {[
              ...
              <div key={idx} className="flex flex-col items-center justify-center gap-2 w-full">
                ...
                <h4 className="text-white font-semibold text-[34px] text-center tracking-tight whitespace-pre-line">
                  {stat.value}{" "}
                  <CounterAnimation end={stat.count} duration={2000} suffix={stat.suffix} className="inline-block" />{" "}
                  {stat.extra}
                </h4>
              </div>
            ))}
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <font className="font-light">
                        브랜드의 개성을 살리되,
                        <br />
                        시장 안에서 팔리는 언어로 재정비합니다.
                        <br />
                        BI / 브랜드 메시지, 핵심 타깃, 마케팅 포인트까지
                      </font>
                      <br />한 줄로 정리되는 브랜드 콘셉트 전략<font className="font-light">을 세웁니다.</font>
                    </p>
                    <p
                      className="text-[13px] text-white leading-snug tracking-[-0.52px]"
                      style={{ fontFamily: "Pretendard, sans-serif" }}
                    >
                      <font className="font-light">우리의 목표:</font> 사람들이 브랜드를{" "}
                      <span className="font-bold underline">기억하게</span> 만들기.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="opacity-100 lg:max-h-0 lg:opacity-0 overflow-hidden lg:group-hover:max-h-[500px] lg:group-hover:opacity-100 transition-all duration-500">
                    ...
                    <div className="space-y-2">
                      <p
                        ...
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        <font className="font-light">브랜드 디자인, 매장 촬영, 오픈 홍보, 가맹 영업까지</font>
                        실행팀이 직접 투입.
                        <br />
                        <font className="font-light">진행 상황은</font> 실시간 리포트로 공유
                        <font className="font-light">되며,</font>
                        <br />
                        <font className="font-light">브랜드 담당자가</font> 즉시 확인
                        <font className="font-light">할 수 있습니다.</font>
                      </p>
                      <p
                        className="text-[13px] font-normal text-white leading-snug tracking-[-0.52px]"
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                ...
                <div className="p-[23px_31px] lg:group-hover:pb-[23px]">
                  ...
                  <div className="opacity-100 lg:max-h-0 lg:opacity-0 overflow-hidden lg:group-hover:max-h-[500px] lg:group-hover:opacity-100 transition-all duration-500">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <font className="font-light">
                          오픈 후에도 신메뉴 개발, 시즌 마케팅, 추가 매장 확정까지
                          <br />
                          꾸준히 함께합니다.
                          <br />
                          계약서로 끝나는 관계가 아니라,
                  ...
                  {isOpen && (
                    <div className="px-3 pb-5 animate-fadeInDown">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4">
                        <div className="px-1">
                          <p
                            className="text-white/90 text-[11px] text-center leading-tight whitespace-pre-line"
                            style={{ fontSize: "15px" }}
                          >
                            {item.general}
                          </p>
                      ...
                      <div className="bg-[#16469E] rounded-lg p-4 border border-[#4A90E2]">
                        <p className="text-white font-bold text-sm mb-2 text-center">
                          <font className="text-[16px]">브릭업</font>{" "}
                          <sup className="text-[10px] align-baseline relative -top-1" style={{ fontWeight: "100" }}>
                            Brickup
                          </sup>
                        </p>
                        <p className="text-[11px] text-center leading-tight" style={{ fontSize: "16px" }}>
                          <font className="text-white whitespace-pre-line" style={{ fontWeight: "100" }}>
                            {item.brickupDetail1}
                          </font>
                ...
                <tr>
                  ...
                  <th className="bg-[#16469E] text-white font-bold text-base lg:text-lg p-4 border-2 border-white/30">
                    <span className="inline-flex items-start gap-1">
                      브릭업
                      <span
                        className="relative top-[4px] text-[0.75em] text-white leading-none"
      ...
      <section className="relative w-full min-h-screen bg-black py-20 lg:py-32 pb-32 lg:pb-32">
        <div className="absolute inset-0 z-0">
          <Image src="/images/design-mode/image.png.jpeg" alt="Background" fill className="object-cover" />
        </div>
            ...
            <div className="px-4 py-8 lg:p-12 max-w-2xl lg:max-w-none mx-auto lg:mx-0 w-full">
              <form
                onSubmit={async (e) => {
                  ...
                  const helpOptions = selectedTypes.filter((t) => t !== "모두")
                  ...
                  const data = {
                    formType: "incubating" as const,
                    platform: (typeof window !== "undefined" && window.innerWidth < 1024 ? "mobile" : "pc") as const,
                    position: "main" as const,
                    type: helpOptions.join(", "),
                  ...
                  setTimeout(() => setIsSubmittingTop(false), 200)
                }}
                className="space-y-6"
              >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="company" // Corrected from name="name"
                    required
                ...
                <div className="mb-3">
                  ...
                  <div className="rounded-lg border border-[#E3E8F2] bg-white px-3.5 py-3 text-[13px] leading-[1.7] text-[#4B5563] max-h-[180px] overflow-auto">
                    회사명(이하 "회사"라 한다)는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와
                    관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립,
                    공개합니다.
                    <br />
                    <br />
                    제1조(개인정보의 처리목적) 회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
                    개인정보는 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등 필요한
                    조치를 이행할 예정입니다.
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-4 bg-[#16469E] text-white font-bold text-lg rounded-lg hover:bg-[#1a5bc4] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmittingTop && (
                    <svg
      ...
      <section
        ...
        style={{
          ...
          paddingBottom: "var(--mobile-sticky-height, 0px)",
        ...
        <div className="relative z-10 h-full max-w-[1180px] mx-auto px-6 flex flex-col">
          ...
          <div className="flex flex-col items-center text-center" style={{ paddingTop: "60px" }}>
            ...
            <button
              ...
              className="mt-6 bg-[#16469E] text-white font-bold rounded-full transition-all duration-300 ease-in-out hover:scale-[1.04] hover:shadow-[0_0_12px_rgba(0,70,190,0.4)]"
              style={{
                width: "165px",
                height: "50px",
                borderRadius: "40px",
          ...
          >
            ...
            <div className="px-6 py-4 overflow-auto text-[14px] leading-[1.7] text-[#4B5563]">
              ...
              <p className="mb-4">
                ...
                피해구제 등)에 관한 사항을 아래와 같이 지정하고 있습니다:
                <br />- 개인정보 보호책임자: 홍길동
          ...
          onSubmit={async (e) => {
            ...
            button.innerHTML = `
              <div class="flex items-center justify-center gap-2">
                <svg class="animate-spin h-4 w-4 text-[#091C40]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        >
          <div className="max-w-[1440px] mx-auto w-full px-4 lg:px-8">
            <div className="max-w-[1180px] mx-auto flex items-center justify-between gap-4">
              ...
              {/* Inquiry Type Select */}
              <select
                name="type" // Changed from name="inquiryType" to name="type"
              ...
              <input
                ...
                name="brand"
                placeholder="브랜드명"
                className="flex-1 min-w-[120px] h-[40px] rounded-md px-3 text-[14px] bg-white text-[#111827] placeholder:text-[#999999] border border-[#D1D9E8] focus:outline-none focus:border-[#16469E] focus:ring-2 focus:ring-[#16469E]/20"
              />

              {/* Name */}
              <input
                type="text"
                name="company" // Changed from name="name" to name="company"
                placeholder="회사명" // Changed placeholder to match new field
              ...
              <label className="flex items-center gap-2 text-white text-[14px] whitespace-nowrap cursor-pointer flex-shrink-0">
                ...
                <span>
                  <span
                    ...
                    onClick={(e) => {
                      e.preventDefault()
                      setShowPrivacyModal(true) // Show privacy modal
                    }}
                  >
                    개인정보수집
                  </span>
              ...
              <button
                type="submit"
                disabled={isSubmittingBottom} // Use isSubmittingBottom for the footer form
                className="flex items-center justify-center w-auto flex-shrink-0 h-[40px] bg-[#FFF200] text-[#091C40] font-semibold rounded-md transition-all duration-300 hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed px-6"
                style={{ minHeight: "40px", minWidth: "120px" }}
              >
                {isSubmittingBottom ? (
                  <div className="flex items-center justify-center gap-2">
                    <svg
                      className="animate-spin h-4 w-4 text-[#091C40]"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
      ...
      <MobileStickyInquiry variant="incubating" />
    </div>
  )
}
