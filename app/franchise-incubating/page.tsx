        ...
        <form
          onSubmit={async (e) => {
            ...
            const data = {
              ...
              type: inquiryType,
              company: brandName, // Reusing brandName for company field in bottom form
              name: name,
              phone: phone,
              brand: brandName, // Keeping brandName for brand field
              message: "", // Bottom form does not have a message field
            }
          ...
          <div className="max-w-[1440px] mx-auto w-full px-4 lg:px-8">
            <div className="max-w-[1180px] mx-auto flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="w-auto flex-shrink-0 h-[40px] hover:brightness-110 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <img
