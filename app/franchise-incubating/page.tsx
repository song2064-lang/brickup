...
export default function FranchiseIncubating() {
  ...
  const comparisonData = [
    {
      title: "핵심 역량",
      general: "내부 인력 중심의 운영, 각 부서 분리",
      incubating: "부분적 대행 또는 프로젝트 단위 컨설팅",
      brickup: "브릭업은 기획-운영-확장 전단계를 본사와 함께 설계합니다.\n외부인이 아닌 공동운영팀 형태입니다.",
      highlight: "기획-운영-확장 전단계를 본사와 함께 설계",
      brickupDetail: "브릭업은 기획-운영-확장 전단계를 본사와 함께 설계합니다. 외부인이 아닌 공동운영팀 형태입니다.",
    },
    {
      title: "브랜딩 / 기획력",
      general: "한정된 리소스, 내부 시각 중심",
      incubating: "비주얼 중심 제안, 실전력 낮음",
      brickup:
        "브릭업은 시장 데이터 기반으로 브랜드의 정체성을 재설계하고,\n소비자 눈높이에 맞는 스토리와 디자인을 동시에 설계합니다.",
      highlight: "스토리와 디자인을 동시에 설계",
      brickupDetail:
        "브릭업은 시장 데이터 기반으로 브랜드의 정체성을 재설계하고, 소비자 눈높이에 맞는 스토리와 디자인을 동시에 설계합니다.",
    },
    {
      title: "가맹 영업",
      general: "본사 담당자 의존, 네트워크 한계",
      incubating: "창업자 세일즈 지원",
      brickup: "브릭업은 본사DB와에 자체 DB + 영업전략시스템으로 리드를 확보하고,\n전 과정을 실시간으로 공유합니다.",
      highlight: "자체 DB + 영업전략시스템",
      brickupDetail:
        "브릭업은 본사DB와에 자체 DB + 영업전략시스템으로 리드를 확보하고, 전 과정을 실시간으로 공유합니다.",
    },
    {
      title: "마케팅",
      ...
      brickup:
        "브릭업은 가맹영업과 마케팅 + 전문 매출형 마케팅을 병행합니다.\n성과는 클릭이 아닌 실제 매출 지표로 관리합니다.",
      highlight: "실제 매출 지표로 관리",
      brickupDetail:
        "브릭업은 가맹영업과 마케팅 + 전문 매출형 마케팅을 병행합니다. 성과는 클릭이 아닌 실제 매출 지표로 관리합니다.",
    },
    {
      title: "운영 / 메뉴 / R&D",
      general: "매뉴 표준화 미흡, 운영 매뉴얼 부족",
      incubating: "자문만 제공",
      brickup:
        "브릭업은 메뉴개발, 원가분석, 조리 프로세스, 운영 매뉴얼까지 구축합니다.\n매장에 즉시 현장 적용 가능한 시스템을 완성합니다.",
      highlight: "현장 적용 가능한 시스템",
      brickupDetail:
        "브릭업은 메뉴개발, 원가분석, 조리 프로세스, 운영 매뉴얼까지 구축합니다. 매장에 즉시 현장 적용 가능한 시스템을 완성합니다.",
    },
    {
      title: "법률 / 계약 관리",
      general: "내부 인력 부재, 분쟁 대응 중심",
      incubating: "외부 로펌 위탁",
      brickup:
        "브릭업은 계약 전 리스크 사전 진단 + 정보공개서 작성 + 상표권 점검까지\n진행합니다. 분쟁 예방 중심의 법률 프로세스 도입 내재화되어 있습니다.",
      highlight: "계약 전 리스크 사전 진단 + 정보공개서 작성 + 상표권 점검",
      brickupDetail:
        "브릭업은 계약 전 리스크 사전 진단 + 정보공개서 작성 + 상표권 점검까지 진행합니다. 분쟁 예방 중심의 법률 프로세스 도입 내재화되어 있습니다.",
    },
    {
      title: "물류 / 공급망",
      general: "각 점포마다 개별 관리,\n원가 협상 못이 가격 상승 중가",
      incubating: "물류 대행만 중개, 통합관리 부재",
      brickup:
        "브릭업은 전국 통합된 협력 네트워크를 통해 원가 경쟁력 확보와\n빠른 공급체계를 유지시켜 점주 만족도와 본사 신뢰도 동시 강화합니다.",
      highlight: "원가 경쟁력 확보",
      brickupDetail:
        "브릭업은 전국 통합된 협력 네트워크를 통해 원가 경쟁력 확보와 빠른 공급체계를 유지시켜 점주 만족도와 본사 신뢰도 동시 강화합니다.",
    },
    {
      title: "확장성 / 지속성",
      general: "단당자 교체나 조직 이탈 시\n시스템 유지 어려움",
      incubating: "프로젝트 종료 후 관리 부재",
      brickup:
        "브릭업은 브랜드별 관리 데시보드로 모든 데이터(영업/마케팅/가맹)를 기록,\n담당자 교체에도 시스템은 유지될 수 있도록 브랜드의 자생력을 기반니다.",
      highlight: "브랜드의 자생력",
      brickupDetail:
        "브릭업은 브랜드별 관리 데시보드로 모든 데이터(영업/마케팅/가맹)를 기록, 담당자 교체에도 시스템은 유지될 수 있도록 브랜드의 자생력을 기반입니다.",
    },
  ]
    ...
    <div className="relative w-full min-h-screen bg-black">
            ...
            {mobileServiceCardsData.map((service, index) => (
              ...
              >
                ...
                >
                  ...
                  {openMobileServiceCard !== index && (
                    <p
                      className="text-[14px] font-bold text-white leading-normal tracking-[-0.56px]"
                      style={{ fontFamily: "Pretendard, sans-serif" }}
                      ...
                      <div className="space-y-2">
                        {service.sections.map((section, sIdx) => (
                          <div key={sIdx} className="mb-3">
                            <h4
                              className="text-[14px] font-normal text-white leading-tight tracking-[-0.56px] mb-1"
                              style={{ fontFamily: "Pretendard, sans-serif" }}
                              dangerouslySetInnerHTML={{ __html: section.title }}
                            />
                            {section.content && (
                              <p
                                className="text-[12px] font-normal text-white/90 leading-snug tracking-[-0.48px]"
                                style={{ fontFamily: "Pretendard, sans-serif" }}
                        ...
                        {service.highlight && (
                          <p
                            className="text-[14px] font-bold text-white leading-tight tracking-[-0.56px] mt-4 pt-3"
                            style={{ fontFamily: "Pretendard, sans-serif" }}
      ...
      <section className="relative py-16 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-16">
          ...
          <div
            ref={statsSectionRef}
            className={`hidden lg:block text-center mb-12 transition-all duration-700 ${
          ...
          <div className="lg:hidden text-center mb-8">
            <h3 className="text-white text-xl font-light leading-tight mb-2">1년 만에 10배 성장을 이룬 브랜드,</h3>
          ...
          <div className="lg:hidden">
            <div className="flex flex-col items-center gap-5 max-w-[615px] mx-auto">
              ...
              <div className="flex flex-col items-center justify-center gap-2 w-full">
                <p className="text-white font-light text-base text-center tracking-tight">6개월만에</p>
                <h4 className="text-white font-semibold text-2xl text-center tracking-tight">
              ...
              {/* Stat 2 */}
              <div className="flex flex-col items-center justify-center gap-2 w-full">
                <p className="text-white font-light text-base text-center tracking-tight">리뉴얼 브랜드</p>
                <h4 className="text-white font-semibold text-2xl text-center tracking-tight">
              ...
              {/* Stat 3 */}
              <div className="flex flex-col items-center justify-center gap-2 w-full">
                <p className="text-white font-light text-base text-center tracking-tight">가맹계약서/점주</p>
                <h4 className="text-white font-semibold text-2xl text-center tracking-tight">
                  분쟁리스크 0건, 법률자문 만족도{" "}
              ...
              {/* Stat 4 */}
              <div className="flex flex-col items-center justify-center gap-2 w-full">
                <p className="text-white font-light text-base text-center tracking-tight">R&D 구축 후</p>
                <h4 className="text-white font-semibold text-2xl text-center tracking-tight">
          ...
          >
            <h3 className="text-white text-2xl lg:text-4xl font-light mb-4">
              ...
              <span className="inline-block px-2 font-bold relative">
                <span className="relative z-10">변화</span>
                <span className="absolute inset-0 bg-[#16469E] -z-10" />
              </span>
            </h3>
          ...
          <div className="hidden lg:flex flex-col items-center gap-5 max-w-[615px] mx-auto">
            {/* Stat 1 */}
            <div
            ...
            <div className="hidden lg:block">
              ...
              >
                <p className="text-white font-light text-base sm:text-lg lg:text-2xl text-center sm:text-right tracking-tight whitespace-nowrap">
                  가맹계약서/점주
                </p>
                  ...
                  <div className="opacity-100 lg:max-h-0 lg:opacity-0 overflow-hidden lg:group-hover:max-h-[500px] lg:group-hover:opacity-100 transition-all duration-500">
                    ...
                    <div className="space-y-2">
                      <p
                        ...
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        인테리어, 메뉴 개발, 마케팅 콘텐츠 제작 등 모든 실행 과정에 브릭업 전문가가 함께합니다.
                      </p>
                      <p
                        className="text-[13px] font-normal text-white leading-snug tracking-[-0.52px]"
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        단순 자문이 아닌, <span className="font-bold underline">실제 현장 투입형 지원</span>으로
                        브랜드가 완성됩니다.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="opacity-100 lg:max-h-0 lg:opacity-0 overflow-hidden lg:group-hover:max-h-[500px] lg:group-hover:opacity-100 transition-all duration-500">
                    ...
                    <div className="space-y-2">
                      <p
                        ...
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        가맹 설명회 기획부터 영업 자료, 온라인 마케팅까지 전 과정을 지원합니다.
                      </p>
                      <p
                        className="text-[13px] font-normal text-white leading-snug tracking-[-0.52px]"
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        브릭업의 영업 노하우로, <span className="font-bold underline">첫 가맹점 오픈까지</span> 함께
                        달립니다.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="opacity-100 lg:max-h-0 lg:opacity-0 overflow-hidden lg:group-hover:max-h-[500px] lg:group-hover:opacity-100 transition-all duration-500">
                    ...
                    <div className="space-y-2">
                      <p
                        ...
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        가맹점 오픈 후에도 매출 분석, 마케팅 개선, 메뉴 업데이트 등을 지속적으로 관리합니다.
                      </p>
                      <p
                        className="text-[13px] font-normal text-white leading-snug tracking-[-0.52px]"
                        style={{ fontFamily: "Pretendard, sans-serif" }}
                      >
                        브릭업은 <span className="font-bold underline">단순 컨설팅이 아닌, 장기 파트너</span>입니다.
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="px-3 pb-5 animate-fadeInDown">
                      <div className="grid grid-cols-2 gap-0 mb-3">
                        <div className="bg-[#5B5B5B] px-2 py-2">
                          <p className="text-white text-xs font-semibold text-center">일반 프랜차이즈 본사</p>
                        </div>
                        <div className="bg-[#5B5B5B] px-2 py-2">
                          <p className="text-white text-xs font-semibold text-center">일반 인큐베이팅</p>
                        </div>
                      </div>

                      <div className="grid grid-cols-2 gap-3 mb-4">
                        <div className="px-1">
                          <p className="text-white/90 text-[11px] text-center leading-tight">{item.general}</p>
                        </div>
                        <div className="px-1">
                          <p className="text-white/90 text-[11px] text-center leading-tight">{item.brickup}</p>
                        </div>
                      </div>

                      <div className="bg-[#16469E] rounded-lg p-4 border border-[#4A90E2]">
                        <p className="text-white font-bold text-sm mb-2 text-center">
                          브랜딩 <sup className="text-[10px] align-baseline relative -top-1">Brickup</sup>
                        </p>
                        <p className="text-white text-[11px] mb-2 text-center leading-tight">{item.brickupDetail}</p>
                        <p className="text-[11px] text-center leading-tight">
                          매장에 즉시{" "}
                          <span style={{ color: "#FFF200" }} className="font-bold">
                            현장 적용 가능한 시스템
                          </span>
                          을 완성합니다.
                        </p>
      ...
      <section className="relative w-full h-[450px] lg:h-[480px] bg-black pb-72 lg:pb-80 mb-36 lg:mb-0">
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          <Image
            ...
            <div className="flex items-center gap-2">
              <label className="flex items-center gap-1.5 text-white text-xs cursor-pointer flex-shrink-0">
                <input
                  ...
                  name="privacy"
                  value="agreed"
                  className="w-4 h-4 rounded border-white/30 bg-white/10 text-[#fff200] focus:ring-2 focus:ring-[#fff200]"
                />
                <span>개인정보 동의</span>
              </label>
          ...
          >
            ...
            <div className="flex-1 flex items-center gap-2 min-w-0">
              ...
              <button
                type="submit"
                disabled={isSubmittingBottom}
                className="bg-[#FFF200] text-[#16469E] font-bold px-8 py-2.5 rounded hover:bg-[#ffed00] transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap text-sm flex-shrink-0"
              >
                {isSubmittingBottom ? "전송 중..." : "문의하기"}
              </button>
            </div>
